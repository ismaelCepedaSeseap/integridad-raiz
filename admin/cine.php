...
<head>
    ...
    <title>Gestión de Cine - Integridad desde la Raíz</title>
    ...
    <link rel="stylesheet" href="../assets/css/pages/cine.css">
...
<body class="font-quicksand">
    ...
    <!-- Mobile Header -->
    <header class="mobile-header" style="display: none;"> <!-- Hidden by default, shown in CSS media query if needed -->
        ...
        <aside id="sidebar" class="sidebar">
            <div class="sidebar__inner">
                ...
                <nav class="navigation">
                    ...
                    <a href="cine.php" id="nav-cine" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <header class="page-header">
                <div class="page-header__title">
                    ...
                    <p>Administra los videos de la sección Cine.</p>
                </div>
                <div class="page-header__actions">
                    <button id="btn-new-item" class="btn btn-primary">
                        <i data-lucide="plus"></i> Nuevo Video
                    </button>
                </div>
            </header>
                    ...
                    <div class="table-container">
                        <div class="table-controls">
                            <div class="table-search">
                                ...
                                <input type="text" id="search-input" placeholder="Buscar por título, estado o hashtag">
                            </div>
                            <p class="section-subtitle" id="item-count">0 videos</p>
                        </div>
    ...
    <!-- Modal -->
    <div id="new-item-modal" class="modal modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modal-title">Nuevo Video</h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6 items-start">
                    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col overflow-hidden h-[calc(90vh-120px)]">
                        <div class="p-6 space-y-4 overflow-y-auto custom-scrollbar flex-1">
                            ...
                            <div id="new-item-form" class="form-grid"></div>
                        </div>
                        <div class="p-4 bg-slate-50 border-t border-slate-200 flex justify-end gap-3">
                            <button id="btn-modal-cancel" class="btn-close-modal px-6 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 rounded-xl transition-all">
                                Cancelar
                            </button>
                            ...
                            <button id="btn-modal-save" class="px-8 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl shadow-lg transition-all active:scale-95">
                                Guardar Video
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="preview-section h-[calc(90vh-120px)] overflow-hidden bg-slate-50/50 p-8 rounded-2xl border border-slate-200 shadow-sm">
                        <div class="w-full flex justify-between items-center mb-6">
                            ...
                            <span class="px-2 py-1 bg-blue-100 text-blue-600 text-[10px] font-bold rounded">CINE</span>
                        </div>
                        ...
                        <div class="w-full bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                            <div class="h-44 bg-slate-100 flex items-center justify-center">
                                <img id="preview-thumb" src="../assets/images/logo.png" alt="Video" class="w-full h-full object-cover">
                            </div>
                            <div class="p-5 space-y-3">
                                <span id="preview-state-badge" class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-blue-100 text-blue-700">Estado</span>
                                <h4 id="preview-title" class="text-lg font-black text-slate-800">Título del Video</h4>
                                <p id="preview-hashtag" class="text-xs text-slate-500">#Hashtag</p>
                                <p id="preview-description" class="text-sm text-slate-600 line-clamp-3">Descripción breve del video.</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 w-full space-y-4">
                            <div class="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                ...
                                <p class="text-xs text-blue-800 leading-relaxed">
                                    Los cambios del formulario se reflejan inmediatamente en esta vista previa.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Scripts -->
    <script src="../assets/js/data/cine-page-data.js"></script>
    <script src="../assets/js/pages/admin/generales/menu.js"></script>
    <script src="../assets/js/pages/admin/cine.js"></script>
</body>
</html>
